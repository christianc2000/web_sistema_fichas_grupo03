        ...
        <div class="col-md-6 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-6"><label class="labels"><h4 class="text-muted ">Apellido/s</h4></label><h6>{{auth()->user()->last_name}}</h6>
                    </div>
                    <div class="row mt-2">
                    <div class="col-md-12"><label class="labels"><h4 class="text-muted ">Celular</h4> </label><h6>{{auth()->user()->number_phone}}</h6>
                    <div class="col-md-12"><label class="labels"><h4 class="text-muted ">E-mail</h4> </label><h6>{{auth()->user()->email}}</h6>
                    <div class="col-md-12"><label class="labels"><h4 class="text-muted ">Fecha de Nacimiento</h6> </label><h5>{{auth()->user()->birth_date}}</h6>
