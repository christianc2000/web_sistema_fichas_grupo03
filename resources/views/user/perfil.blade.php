        ...
        <div class="card" style="width: 70%;">
            <div class="row">
                <div class="col-md-5 border-right">
                    <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-8"
                            width="150px" src="{{ auth()->user()->photo ? Storage::disk('s3')->url(auth()->user()->photo) : '#' }}"><span
                    ...
                    <div class="p-3 py-5">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6"><label class="labels ">
                                ...
                                <div class="col-md-6"><label class="labels">
                                        <h4 class="text-muted ">Apellido/s</h4>
                                    </label>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-12"><label class="labels">
                                        ...
                                        <h6>{{ auth()->user()->number_phone }}</h6>
                                        <div class="col-md-12"><label class="labels">
                                                <h4 class="text-muted ">E-mail</h4>
                                            </label>
                                            <h6>{{ auth()->user()->email }}</h6>
                                            <div class="col-md-12"><label class="labels">
                                                    <h4 class="text-muted ">Fecha de Nacimiento</h6>
                                                </label>
                                                <h5>{{ auth()->user()->birth_date }}</h6>
