        ...
        <div class="card" style="width: 100%;">
            <div class="card-body">
                <form action="{{ route('user.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="lastname" id="lastname"
                                    placeholder="APELLIDO" value="{{ $user->lastname }}" required>
                        ...
                        <div class="col-md">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="number_phone" id="number_phone"
                                    placeholder="NÚMERO DE CELULAR" value="{{ $user->number_phone }}" required>
                        ...
                        <div class="col-md">
                            <div class="form-floating mb-3">
                                <select class="form-select" id="marital_status" name="marital_status"
                                    ...
                                    <option value="SOLTERO/A" @if ($user->marital_status === 'SOLTERO/A') selected @endif>Soltero/a
                                    </option>
                                    <option value="CASADO/A" @if ($user->marital_status === 'CASADO/A') selected @endif>Casado/a
                                    </option>
                                    <option value="VIUDO/A" @if ($user->marital_status === 'VIUDO/A') selected @endif>Viudo/a
                                    </option>
                                    <option value="DIVORCIADO/A" @if ($user->marital_status === 'DIVORCIADO/A') selected @endif>
                                        Divorciado/a</option>
                                    <option value="OTRO" @if ($user->marital_status === 'OTRO') selected @endif>Otro</option>
                                </select>
                        ...
                        <div class="col-md">
                            <div class="form-floating mb-3">
                                <input type="date" class="form-control" name="birth_date" id="birth_date"
                                    placeholder="FECHA DE NACIMIENTO" value="{{ $user->birth_date }}" required>
                        ...
                        <div class="col-md">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="current_residence"
                                    id="current_residence" placeholder="RESIDENCIA"
                                    value="{{ $user->current_residence }}" required>
                        ...
                        <div class="col-md">
                            <div class="form-floating mb-3">
                                <input type="date" class="form-control" name="registration_date"
                                    id="registration_date" placeholder="REGISTRO" value="{{ $user->registration_date }}"
                                    disabled>
                    ...
                    <!-- Resto de campos del formulario (nombre, apellido, etc.) -->
                    <!-- ... -->

                    <!-- Input para cargar la foto con vista previa -->
                    <div class="row g-2">
                        <div class="col-md">
                            <div class="form-floating mb-3">
                        ...
                        <div class="col-md">
                            <div class="form-floating mb-3">
                                <select class="form-select tipos" id="type" name="type"
                                    aria-label="Floating label select example" disabled>
                                    <option value="A" @if ($user->type === 'A') selected @endif>Administrador
                                    </option>
                                    <option value="D" @if ($user->type === 'D') selected @endif>Doctor/a
                                    </option>
                                    <option value="E" @if ($user->type === 'E') selected @endif>Enfermero/a
                                    </option>
                                    <option value="P" @if ($user->type === 'P') selected @endif>Paciente
                                    </option>
                                </select>
                        ...
                        <div class="col-md">
                            <div class="mb-3">
                                <div id="imagePreview"
                                    ...
                                    <img id="preview"
                                        src="{{ $user->photo ? Storage::disk('s3')->url($user->photo) : '#' }}"
                                        alt="Vista previa"
                                        style="{{ $user->photo ? 'display: block' : 'display: none' }}; max-width: 300px; max-height: 300px;">
                                    <span id="noImageText"
                                        style="{{ $user->photo ? 'display: none' : 'display: block' }}">Imagen
                                        no
                                        seleccionada</span>
                                </div>
                            </div>
                    ...
                    <!-- Resto del formulario es igual a como está en el formulario de creación -->
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="speciality" id="speciality"
                                        ...
                                        value="{{ $user->type == 'D' ? $user->doctor->speciality : '' }}">
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="function" id="function"
                                        ...
                                        value="{{ $user->type == 'E' ? $user->enfermera->function : '' }}">
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="occupation" id="occupation"
                                        ...
                                        value="{{ $user->type == 'P' ? $user->paciente->occupation : '' }}">
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="children" id="children"
                                        placeholder="Hijos"
                                        value="{{ $user->type == 'P' ? $user->paciente->children : '' }}">
